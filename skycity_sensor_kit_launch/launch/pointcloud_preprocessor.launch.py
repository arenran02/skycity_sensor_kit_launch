...
def generate_launch_description():
    ...
    # 🔧 여기: sample -> skycity 로 변경
    skycity_sensor_kit_launch_share_dir = get_package_share_directory(
        "skycity_sensor_kit_launch"
    )
    ...
    add_launch_arg(
        ...
        os.path.join(
            skycity_sensor_kit_launch_share_dir,
            "config",
